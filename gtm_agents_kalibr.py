...
class ComplianceGate:
    ...
    def validate_outreach(self, message: str, has_ai_disclosure: bool) -> Dict:
        """Validate outreach message for compliance risks."""
        blockers = []

        # Check for AI disclosure
        if COMPLIANCE_BLOCKERS["no_ai_disclosure"] and not has_ai_disclosure:
...
Return ONLY valid JSON, no other text."""
            ...
            try:
                ...
                # Compliance check on generated message
